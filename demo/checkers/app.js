...
{
	if (region.bo.aH === region.bI.aH)
	{
		return 'on line ' + region.bo.aH;
	}
	return 'on lines ' + region.bo.aH + ' through ' + region.bI.aH;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { du: 'hidden', c7: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { du: 'mozHidden', c7: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { du: 'msHidden', c7: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { du: 'webkitHidden', c7: 'webkitvisibilitychange' }
		: { du: 'hidden', c7: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bL: fragment, bT: host, b9: path, cb: port_, ce: protocol, cf: query};
	});
...
var $author$project$Checkers$Main$Man = 0;
	...
	return A2(
		...
		function (rank) {
			return A2(
				...
				function (file) {
					return $author$project$Checkers$Main$isDarkSquare(
...
var $author$project$Checkers$Main$initialBoard = $elm$core$Dict$fromList(
	_Utils_ap(
...
var $author$project$Checkers$Main$BlackBottom = 1;
var $author$project$Checkers$Main$ClearFlash = {$: 4};
...
var $author$project$Checkers$Main$King = 1;
var $author$project$Checkers$Main$reachesPromotionRow = F2(
	function (player, rank) {
		return ((!player) && (rank === 7)) || ((player === 1) && (!rank));
	});
...
var $author$project$Checkers$Main$boardAfterAction = F5(
	function (board, from, to, piece, isCaptureMove) {
		...
		var boardWithoutCaptured = function () {
			if (isCaptureMove) {
				var capturedSquare = _Utils_Tuple2(((from.a + to.a) / 2) | 0, ((from.b + to.b) / 2) | 0);
				return A2($elm$core$Dict$remove, capturedSquare, boardWithoutFrom);
			} else {
				return boardWithoutFrom;
			}
		}();
		return A3($elm$core$Dict$insert, to, promotedPiece, boardWithoutCaptured);
	});
...
var $author$project$Checkers$Main$movementDirections = function (piece) {
	var _v0 = piece.Z;
	if (_v0 === 1) {
		return _List_fromArray(
			[
...
var $author$project$Checkers$Main$onBoard = function (_v0) {
	var file = _v0.a;
	var rank = _v0.b;
	return (file >= 0) && ((file < 8) && ((rank >= 0) && (rank < 8)));
};
var $author$project$Checkers$Main$captureMovesFrom = F3(
	function (board, _v0, piece) {
		var file = _v0.a;
		var rank = _v0.b;
		return A2(
			$elm$core$List$filterMap,
			function (_v1) {
				var dx = _v1.a;
				var dy = _v1.b;
				var middle = _Utils_Tuple2(file + dx, rank + dy);
				var landing = _Utils_Tuple2(file + (2 * dx), rank + (2 * dy));
				if ($author$project$Checkers$Main$onBoard(middle) && $author$project$Checkers$Main$onBoard(landing)) {
					var _v2 = _Utils_Tuple2(
						A2($elm$core$Dict$get, middle, board),
						A2($elm$core$Dict$get, landing, board));
					if ((!_v2.a.$) && (_v2.b.$ === 1)) {
			...
			$author$project$Checkers$Main$movementDirections(piece));
	});
...
var $author$project$Checkers$Main$justPromoted = F2(
	function (before, after) {
		return (!before.Z) && (after.Z === 1);
	});
var $elm$core$Basics$not = _Basics_not;
var $author$project$Checkers$Main$otherPlayer = function (player) {
	return (!player) ? 1 : 0;
};
		...
		if (maybePiece.$ === 1) {
			...
			var mustContinueCapture = function () {
				if (pieceAtTarget.$ === 1) {
					...
					var movedPiece = pieceAtTarget.a;
					return isCaptureMove && ((!A2($author$project$Checkers$Main$justPromoted, piece, movedPiece)) && (!$elm$core$List$isEmpty(
						A3($author$project$Checkers$Main$captureMovesFrom, boardAfterMove, to, movedPiece))));
				}
			}();
...
var $author$project$Checkers$Main$requiredCaptureStarts = F3(
	function (board, turn, forcedFrom) {
		if (!forcedFrom.$) {
			var sq = forcedFrom.a;
			...
			return A2(
				...
				function (_v3) {
					...
					return $elm$core$List$isEmpty(
						A3($author$project$Checkers$Main$captureMovesFrom, board, sq, piece)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(sq);
				},
				A2(
...
var $author$project$Checkers$Main$simpleMovesFrom = F3(
	function (board, _v0, piece) {
		var file = _v0.a;
		var rank = _v0.b;
		return A2(
			...
			function (sq) {
				return _Utils_eq(
					A2($elm$core$Dict$get, sq, board),
					$elm$core$Maybe$Nothing);
			},
			A2(
				$elm$core$List$filter,
				$author$project$Checkers$Main$onBoard,
				A2(
					$elm$core$List$map,
					function (_v1) {
						var dx = _v1.a;
						var dy = _v1.b;
						return _Utils_Tuple2(file + dx, rank + dy);
					},
					$author$project$Checkers$Main$movementDirections(piece))));
	});
var $author$project$Checkers$Main$legalDestinations = F4(
	function (board, turn, forcedFrom, from) {
		var _v0 = A2($elm$core$Dict$get, from, board);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			var piece = _v0.a;
			if (!_Utils_eq(piece.C, turn)) {
				...
				return A2($elm$core$List$member, from, captureStarts) ? A3($author$project$Checkers$Main$captureMovesFrom, board, from, piece) : (($elm$core$List$isEmpty(captureStarts) && _Utils_eq(forcedFrom, $elm$core$Maybe$Nothing)) ? A3($author$project$Checkers$Main$simpleMovesFrom, board, from, piece) : _List_Nil);
			}
		}
	});
var $author$project$Checkers$Main$legalMoveStarts = F2(
	function (board, turn) {
		return A2(
			$elm$core$List$filterMap,
			function (_v1) {
				...
				var piece = _v1.b;
				return $elm$core$List$isEmpty(
					A3($author$project$Checkers$Main$simpleMovesFrom, board, sq, piece)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(sq);
			},
			A2(
				$elm$core$List$filter,
				function (_v0) {
...
var $author$project$Checkers$Main$possibleMoves = F3(
	function (board, turn, forcedFrom) {
		var captureStarts = A3($author$project$Checkers$Main$requiredCaptureStarts, board, turn, forcedFrom);
		var starts = function () {
			if ($elm$core$List$isEmpty(captureStarts)) {
				if (forcedFrom.$ === 1) {
					return A2($author$project$Checkers$Main$legalMoveStarts, board, turn);
				} else {
					var sq = forcedFrom.a;
					return _List_fromArray(
						[sq]);
		...
		return A2(
			...
			function (from) {
				return A2(
					...
					A4($author$project$Checkers$Main$legalDestinations, board, turn, forcedFrom, from));
			},
			starts);
	});
var $author$project$Checkers$Main$gameOutcome = F3(
	function (board, turn, forcedFrom) {
		var piecesForTurn = A2(
			$elm$core$List$filter,
			function (_v0) {
				var piece = _v0.b;
				return _Utils_eq(piece.C, turn);
		...
		var hasAnyMove = !$elm$core$List$isEmpty(
			A3($author$project$Checkers$Main$possibleMoves, board, turn, forcedFrom));
		return ($elm$core$List$isEmpty(piecesForTurn) || (!hasAnyMove)) ? $elm$core$Maybe$Just(
			$author$project$Checkers$Main$otherPlayer(turn)) : $elm$core$Maybe$Nothing;
	});
			...
			if (_v1.$ === 1) {
				...
				return A2($elm$core$List$member, square, movesFromSelected) ? _Utils_Tuple2(
					...
					_Utils_update(
						model,
						{
							Y: $elm$core$Maybe$Just(square),
							ad: $elm$core$Maybe$Nothing
						}),
					A2(
						$elm$core$Task$perform,
						function (_v2) {
							return $author$project$Checkers$Main$ClearFlash;
						},
						$elm$core$Process$sleep(220)));
			}
		}
	});
var $author$project$Checkers$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var square = msg.a;
				return A2($author$project$Checkers$Main$handleClick, square, model);
			case 1:
...
var $author$project$Checkers$Main$LabelMustCapture = function (a) {
	return {$: 3, a: a};
};
var $author$project$Checkers$Main$LabelTurn = function (a) {
	return {$: 2, a: a};
};
var $author$project$Checkers$Main$LabelWinner = function (a) {
	return {$: 4, a: a};
};
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Checkers$Main$tr = F2(
	function (lang, label) {
		var _v0 = _Utils_Tuple2(lang, label);
		switch (_v0.a) {
			case 0:
				switch (_v0.b.$) {
					case 0:
					...
					case 3:
						if (!_v0.b.a) {
							var _v25 = _v0.a;
							var _v26 = _v0.b.a;
							return 'White must capture';
						} else {
							var _v27 = _v0.a;
							var _v28 = _v0.b.a;
							return 'Black must capture';
						}
					default:
						if (!_v0.b.a) {
							var _v37 = _v0.a;
...
var $author$project$Checkers$Main$viewBanner = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'font-size', 'clamp(18px, 3.7vw, 28px)'),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(bannerText)
			]));
};
var $author$project$Checkers$Main$ClickSquare = function (a) {
	return {$: 0, a: a};
};
var $author$project$Checkers$Main$displayToBoard = F3(
...
var $author$project$Checkers$Main$drawPiece = F5(
	function (x, y, cell, square, piece) {
		var outerR = cell * 0.33;
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$core$String$fromFloat(cell * 0.11)),
						$elm$svg$Svg$Attributes$fill('none'),
						$elm$svg$Svg$Attributes$stroke(ringColor),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Checkers$Main$ClickSquare(square))
				]),
			_Utils_ap(
				_List_fromArray(
					[
...
var $author$project$Checkers$Main$drawSquare = F6(
	function (model, cell, selected, legalTargets, displayCol, displayRow) {
		...
		var baseColor = $author$project$Checkers$Main$isDarkSquare(boardSquare) ? '#769656' : '#eeeed2';
		var selectedColor = _Utils_eq(
			model.Y,
		...
		var pieceSvg = function () {
			if (maybePiece.$ === 1) {
				...
				return _List_fromArray(
					[
						A5($author$project$Checkers$Main$drawPiece, x, y, cell, boardSquare, piece)
					]);
			}
		}();
		return A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt(cell)),
							$elm$svg$Svg$Attributes$fill(selectedColor),
							$elm$svg$Svg$Attributes$stroke('#3a3a3a'),
							$elm$svg$Svg$Attributes$strokeWidth('0.4'),
							$elm$svg$Svg$Events$onClick(
							$author$project$Checkers$Main$ClickSquare(boardSquare))
						]),
					_List_Nil),
				pieceSvg));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'0 0 ' + ($elm$core$String$fromInt(pixelSize) + (' ' + $elm$core$String$fromInt(pixelSize)))),
					$elm$svg$Svg$Attributes$width('min(96vw, 96vh)'),
					$elm$svg$Svg$Attributes$height('min(96vw, 96vh)'),
					$elm$svg$Svg$Attributes$style('max-width:700px; max-height:700px; display:block; border:2px solid #2d2d2d; box-sizing:border-box;')
				]),
			squares);
	});
...
var $author$project$Checkers$Main$ResetGame = {$: 1};
var $author$project$Checkers$Main$SwapOrientation = {$: 2};
...
var $author$project$Checkers$Main$actionButton = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'padding', '12px 18px'),
					A2($elm$html$Html$Attributes$style, 'font-size', '17px'),
					A2($elm$html$Html$Attributes$style, 'font-weight', '700'),
					A2($elm$html$Html$Attributes$style, 'min-width', '118px'),
					A2($elm$html$Html$Attributes$style, 'min-height', '48px'),
					A2($elm$html$Html$Attributes$style, 'border', '2px solid #2d2d2d'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '10px'),
					A2($elm$html$Html$Attributes$style, 'background', 'linear-gradient(#ffffff, #eaeaea)'),
					A2($elm$html$Html$Attributes$style, 'box-shadow', '0 2px 0 #9a9a9a'),
...
var $author$project$Checkers$Main$SetLang = function (a) {
	return {$: 3, a: a};
};
var $author$project$Checkers$Main$langCode = function (lang) {
	switch (lang) {
		case 0:
			return 'EN';
		case 1:
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Checkers$Main$SetLang(lang)),
					A2($elm$html$Html$Attributes$style, 'padding', '10px 14px'),
					A2($elm$html$Html$Attributes$style, 'font-size', '16px'),
					A2($elm$html$Html$Attributes$style, 'min-width', '72px'),
					A2($elm$html$Html$Attributes$style, 'min-height', '48px'),
					A2($elm$html$Html$Attributes$style, 'border', '2px solid #2d2d2d'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '10px'),
					A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
					...
					'background',
					active ? 'linear-gradient(#e7f2ff, #bfdcff)' : 'linear-gradient(#ffffff, #eaeaea)'),
					A2(
					$elm$html$Html$Attributes$style,
					'box-shadow',
					active ? 'inset 0 0 0 1px #8ab7e8, 0 2px 0 #9a9a9a' : '0 2px 0 #9a9a9a')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Checkers$Main$langCode(lang))
				]));
	});
var $author$project$Checkers$Main$viewControls = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Checkers$Main$languageButton, model, 2)
			]));
};
var $author$project$Checkers$Main$view = function (model) {
	var boardPixelSize = 640;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'width', 'min(96vw, 96vh)'),
				...
				_List_fromArray(
					[
						$author$project$Checkers$Main$viewControls(model),
						$author$project$Checkers$Main$viewBanner(model),
						A2($author$project$Checkers$Main$viewBoard, model, boardPixelSize)
					]))
			]));
};
var $author$project$Checkers$Main$main = $elm$browser$Browser$element(
	{
		dB: function (_v0) {
			return _Utils_Tuple2($author$project$Checkers$Main$initialModel, $elm$core$Platform$Cmd$none);
		},
		es: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		eP: $author$project$Checkers$Main$update,
		eQ: $author$project$Checkers$Main$view
	});
_Platform_export({'Checkers':{'Main':{'init':$author$project$Checkers$Main$main(
